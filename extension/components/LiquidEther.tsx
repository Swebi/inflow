 ...
 *
 * Faithful port of reactbits.dev/backgrounds/liquid-ether (ts-tailwind
 * variant). Kept close to 1:1 with upstream so it stays easy to re-sync;
 * project-specific tuning (palette, intensity) is passed in as props from
 * the caller, not edited here. Only used on the unauthenticated Landing
 * screen, and imported lazily so the Dashboard bundle never pulls `three`.
 */
